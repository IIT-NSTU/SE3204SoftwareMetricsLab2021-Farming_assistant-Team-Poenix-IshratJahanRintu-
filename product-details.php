              ...
              ?>
                                   ...
                                   <div class="box">
                                          <div class="product-box-content">
                                                 ...
                                                 <a href="productHandler.php?update_id=<?php echo $product['product_id']; ?>" class="bttn">update</a>
                                                 <a href="productHandler.php?delete_id=<?php echo $product['product_id']; ?>" class="dlt-btn" onclick="return confirm('delete this product?');">delete</a>
                                          </div>
                                   </div>
...
<section class="edit-product-form">
       ...
       ?>
                            <form action="" method="post" enctype="multipart/form-data">
                                   <input type="hidden" name="update_p_id" value="<?php echo $product_update['product_id']; ?>">
                                   <input type="hidden" name="update_old_image" value="<?php echo $product_update['product_img']; ?>">
                                   <input type="text" name="update_name" class="box" placeholder="পণ্যের নাম দিন" required value="<?php echo $product_update['name']; ?>">

                                   <select name="update_category" id="" class="box" required>
                                          <option value="" selected>পণ্যের ধরণ নির্ধারণ করুন</option>
                                          <option value="সবজি">সবজি</option>
                                          <option value="সবজি">সবজি</option>
                                          <option value="সবজি">সবজি</option>
                                   </select>
                                   <select name="update_quantity_type" id="" class="box" required>
                                          <option value="" selected>পণ্যের একক নির্ধারণ করুন</option>
                                          <option value="কেজি">কেজি</option>
                                          <option value="টি">টি</option>
                                   ...
                                   <input type="number" min="1" name="update_quantity" class="box" placeholder="পণ্যের পরিমাণ লিখুন" required value="<?php echo $product_update['quantity']; ?>">

                                   <input type="number" min="1" name="update_unit_price" class="box" placeholder=" প্রতি এককে মূল্য লিখুন" required value="<?php echo $product_update['unit_price']; ?>">


                                   <input type="file" name="update_image" accept="image/jpg, image/jpeg, image/png" class="box" required>
                                   <div id="btn-img-grp">
                                          <img src="../assets/uploaded_img/product/<?php echo $product_update['product_img']; ?>" alt="">
                                          <div class="buttons-grp"> <input id="updatebutton" type="submit" value="update" name="update_product" class="bttn">
                                                 <input type="reset" value="cancel" id="close-update" class="dlt-btn" onclick="hide()">
                                          </div>
                                   </div>
                            </form>
       <?php
